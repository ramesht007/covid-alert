...
export default {
  ...
  jp: {
    message:
      '過去72時間に現在位置から100 m以内に検出された検証済みcovid-19患者. 助言：あなたが去るなら、落ち着いて静かにしなさい.',
    scanning: '積極的にスキャンいます',
    body: (
      <>
        このアップは <B>匿名で</B> あなたの現在地をバックグラウンドで匿名で記録し、COVID-19の患者の既知の以前の場所に近づいたときにスマホに通知を送信します。.{' '}
        <B>動作させるには、このアプリを開いたままにしてください.</B>
      </>
    ),
    getStarted: '始めるのために、おねがいします',
    locationSharing: '現在地の共有を有効にする（常に)',
